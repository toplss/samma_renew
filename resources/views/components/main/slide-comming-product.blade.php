...
<div class="sale-item-list">
    <ul class="{{ $sold_out ? 'end' : '' }}">
        ...
        <li class="si-img" onclick="location.href = '/mall/shop/view?it_id={{ $it_id }}'; "><img src="{{ asset($image_url) }}">
        <!-- <p>160개 돌파<img src="{{ asset('images/icon/fire.svg') }}"></p> -->
    </li>
        @else
        <li class="si-img" onclick="location.href = '/mall/shop/view?it_id={{ $it_id }}'; "><img src="{{ asset('images/common/no_image.gif') }}">
        <!-- <p>160개 돌파<img src="{{ asset('images/icon/fire.svg') }}"></p> -->
    </li>
        @endif
