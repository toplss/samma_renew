...
<div class="sub-container">
    ...
    <div class="kitchen-content">
      <img src="{{ asset('images/sub/ks2_01.jpg') }}">
      <img src="{{ asset('images/sub/ks2_02.jpg') }}">
      <img src="{{ asset('images/sub/ks2_03.jpg') }}">
      <img src="{{ asset('images/sub/ks2_04.jpg') }}">
      <img src="{{ asset('images/sub/ks2_05.jpg') }}">
			<img src="{{ asset('images/sub/ks2_06.jpg') }}">
    </div>
