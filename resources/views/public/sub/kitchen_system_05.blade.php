...
<div class="sub-container">
  ...
  <div class="kitchen-wrap">
    ...
    <div class="kitchen-content">
      <img src="{{ asset('images/sub/ks5_01.jpg') }}">
      <img src="{{ asset('images/sub/ks5_02.jpg') }}">
      <img src="{{ asset('images/sub/ks5_03.jpg') }}">
      <img src="{{ asset('images/sub/ks5_04.jpg') }}">
      <img src="{{ asset('images/sub/ks5_05.jpg') }}">
    </div>
