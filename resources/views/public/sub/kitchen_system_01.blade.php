...
<div class="sub-container">
    ...
    <div class="kitchen-content">
      <img src="{{ asset('images/sub/ks1_01.jpg') }}">
      <img src="{{ asset('images/sub/ks1_02.jpg') }}">
      <img src="{{ asset('images/sub/ks1_03.jpg') }}">
      <img src="{{ asset('images/sub/ks1_04.jpg') }}">
      <img src="{{ asset('images/sub/ks1_05.jpg') }}">
			<img src="{{ asset('images/sub/ks1_06.jpg') }}">
    </div>
