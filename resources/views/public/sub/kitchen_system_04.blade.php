...
<div class="sub-container">
  ...
  <div class="kitchen-wrap">
    ...
    <div class="kitchen-content">
      <img src="{{ asset('images/sub/ks4_01.jpg') }}">
      <img src="{{ asset('images/sub/ks4_02.jpg') }}">
      <img src="{{ asset('images/sub/ks4_03.jpg') }}">
      <img src="{{ asset('images/sub/ks4_04.jpg') }}">
      <img src="{{ asset('images/sub/ks4_05.jpg') }}">
    </div>
