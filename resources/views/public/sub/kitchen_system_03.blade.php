...
<div class="sub-container">
    ...
    <div class="kitchen-content">
      <img src="{{ asset('images/sub/ks3_01.jpg') }}">
      <img src="{{ asset('images/sub/ks3_02.jpg') }}">
      <img src="{{ asset('images/sub/ks3_03.jpg') }}">
      <img src="{{ asset('images/sub/ks3_04.jpg') }}">
      <img src="{{ asset('images/sub/ks3_05.jpg') }}">
    </div>
